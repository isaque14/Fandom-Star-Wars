    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePersonage", x => new { x.MoviesId, x.PersonagesId });
                    table.ForeignKey(
                        name: "FK_MoviePersonage_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviePersonage_Personages_PersonagesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviePersonage_PersonagesId",
                table: "MoviePersonage",
                column: "PersonagesId");
        }
